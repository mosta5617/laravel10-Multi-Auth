        ...
        <div class="flex-grow-1 me-2">
            ...
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" href="#" id="profileDropdown" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                  ...
                  <img id="newimage" class="wd-30 rounded-circle" src="{{ !empty($profile_data->photo) ? url('upload/admin-images/' . $profile_data->photo) : url('upload/no-image.jpg') }}" alt="profile">
                </a>
...
{{-- Admin Profile Image set --}}
  ...
  <img class="wd-60 rounded-circle" src="{{ !empty($profile_data->photo) ? url('upload/admin-images/' . $profile_data->photo) : url('upload/no-image.jpg') }}" alt="profile">
